...
function displayMoviesFromDatabase()
{
    ...
    foreach ($movies as $movie) {
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<a href='/kinobaza-on-php/views/{$row['title']}.php'><img src='{$row['image_address']}' alt='{$row['title']}'></a>";
            echo "<div class='film_label'><a href='/kinobaza-on-php/html/views.php'>{$row['title']}</a></div>";
            echo "</div>";
        }
    }
